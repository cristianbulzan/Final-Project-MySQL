...
The name of the database is: **Store** and it was created under the following structure that can be accessed here: [Store Database Structure](https://github.com/cristianbulzan/Final-Project-MySQL/blob/main/Diagram%20Store%20SQL%20database.mwb)
